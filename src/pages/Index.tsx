    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container relative py-20 lg:py-32">
          <div className="max-w-3xl mx-auto text-center animate-fade-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/15 border border-white/30 mb-6">
              ...
              <span className="text-sm font-medium text-white">Digital Leave Management System</span>
            </div>
            
            <h1 className="text-4xl lg:text-6xl font-display font-bold mb-6 leading-tight text-white">
              Streamline Your
      ...
      <footer className="border-t py-8">
        <div className="container text-center text-sm text-muted-foreground">
          <p>© 2024 ApproveIQ. Digital Leave Approval System for Educational Institutions.</p>
        </div>
      </footer>
    </div>
  );
